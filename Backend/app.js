...
app.put('/play', authMiddleware.notLoggedIn,playController.put)
app.delete('/play', authMiddleware.notLoggedIn,playController.del)
...
app.put('/record',authMiddleware.notLoggedIn, recordController.put)
app.delete('/record', authMiddleware.notLoggedIn,recordController.del)
